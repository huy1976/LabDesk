...
* 🔶 **`LabDesk.SeedWork.Application/`** — [🔗 Xem Docs Application]([https://your-link-here.com](https://learn.microsoft.com/en-us/dotnet/architecture/microservices/microservice-ddd-cqrs-patterns/seedwork-domain-model-base-classes-interfaces)
